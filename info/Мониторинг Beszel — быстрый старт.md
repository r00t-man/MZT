...
> [!NOTE]
> Официальный сайт Beszel у пользователей из России часто открывается только через VPN. Поэтому здесь — короткая памятка на русском, чтобы всё было под рукой.
