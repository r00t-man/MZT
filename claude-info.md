...
> Заставляет модель разбивать задачу на последовательность логических шагов.

### Что делает

- уменьшает количество логических ошибок;
- улучшает качество анализа;
- помогает при сложных технических задачах.
...
Для всего README я бы использовал такой шаблон:
