...
# ═══════════════════════════════════════════════════════════════════════════
head_ "1/3 — Сканирую Docker-контейнеры (включая остановленные)"
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
head_ "2/3 — SSH-доступ к твоим нодам/серверам (опционально)"
# ═══════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════
head_ "3/3 — Вход НА ЭТОТ сервер по ключу с твоего компьютера (опционально)"
# ═══════════════════════════════════════════════════════════════════════════
