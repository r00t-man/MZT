...
Три шага, каждый **опциональный** (кроме сканирования контейнеров — оно read-only и безопасно всегда):
...
Любой из шагов 2️⃣/3️⃣ можно пропустить (`n` или просто `Enter`) — тогда мастер печатает **те же
